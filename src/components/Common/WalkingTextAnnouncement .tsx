...
export const WalkingTextAnnouncement = () => {
  const messages = [
    "🚀 LIVE AI SOFTWARE BUILDING SEMINAR — Build apps with AI • No coding required",
    "🤖 Learn how AI builds frontend & backend applications — Live demonstration",
    "🎓 Open to students, undergraduates & professionals across Nigeria & West Africa",
    "🌍 Build real software, deploy live & position yourself for global tech jobs"
  ];
    ...
    <section className="py-16 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border-y border-white/10">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
              Build Software Using AI — No Coding Required
            </span>
          </h2>

          <p className="text-xl text-white/70 mb-8 leading-relaxed">
            Join our live seminar and see how real frontend and backend applications
            are built using AI tools — even if you have never written code before.
            Perfect for students, undergraduates, and professionals in Nigeria and West Africa.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="flex items-center justify-center space-x-3 text-white/70">
              <Calendar className="w-6 h-6 text-cyan-400" />
              <div className="text-left">
                <div className="font-semibold text-white">Live Date</div>
                <div className="text-sm">Online Session</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center space-x-3 text-white/70">
              <Clock className="w-6 h-6 text-cyan-400" />
              <div className="text-left">
                <div className="font-semibold text-white">Live & Practical</div>
                <div className="text-sm">Real-Time AI Demo</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center space-x-3 text-white/70">
              <Users className="w-6 h-6 text-cyan-400" />
              <div className="text-left">
                <div className="font-semibold text-white">Limited Seats</div>
                <div className="text-sm">High-Impact Training</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 flex items-center justify-center space-x-2 text-white/60 text-sm">
            ...
            <span>•</span>
            <span>✅ Learn by watching AI build live</span>
          </div>
        </motion.div>
      </div>
    </section>
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="hero-content">
                ...
                >
                  <Zap className="w-4 h-4 text-cyan-400" />
                  <span className="text-cyan-300 text-sm font-semibold">
                    LIVE AI SOFTWARE SEMINAR
                  </span>
                </motion.div>

                <h1 className="mb-6 text-4xl font-bold leading-tight text-black dark:text-white sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">
                  Build Real Software Using AI
                </h1>
                <p className="mb-10 text-lg leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  Discover how AI can build frontend and backend applications for you —
                  without learning any programming language.
                  <strong> Open to Nigerian students, undergraduates, and professionals.</strong>
                </p>
                ...
                <div className="mt-8 flex flex-wrap gap-4 text-sm text-body-color dark:text-body-color-dark">
                  ...
                  <div className="flex items-center space-x-2">
                    <Clock className="w-4 h-4 text-cyan-500" />
                    <span>Practical AI Demonstration</span>
                  </div>
                  <div className="flex items-center space-x-2">
