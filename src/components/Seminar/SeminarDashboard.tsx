...
//     try {
//       let  res = await initiateCheckoutV2(request as any, true);
...
//                 Welcome to the Tech Career Breakthrough Seminar!
//               </h1>
...
//                 {/* <p>✅ <strong>Check your email</strong> for seminar access details</p> */}
...
//               >
//                 <div 
//                   className="aspect-video bg-gradient-to-br from-cyan-500/20 to-blue-600/20 flex items-center justify-center cursor-pointer relative"
//                   onClick={() => setShowVideo(true)}
//                 >
//                   <div className="text-center">
//                     <div className="w-20 h-20 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center mb-4 mx-auto hover:bg-white/30 transition-colors duration-300">
//                       <Play className="w-8 h-8 text-white ml-1" />
//                     </div>
//                     <p className="text-white/80 font-semibold">Watch Seminar Trailer</p>
//                     <p className="text-white/60 text-sm mt-2">See how this seminar has transformed lives</p>
//                   </div>
//                 </div>
//               </motion.div>
...
//                     className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-red-600 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-red-500/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-3"
//                   >
...
//                   <div>📧 support@techcareerng.com</div>
...
//                 <p className="text-white/80 text-lg">Seminar Trailer Video</p>
//                 <p className="text-white/60 text-sm mt-2">
//                   This would be an engaging video highlighting the seminar value
//                 </p>
//               </div>
//             </div>
//             <button
...
// // Separate Payment Button Component for reusability
// const PaymentButton = ({ handlePayment, isProcessing, seminarData, timeLeft, setHasPaid }) => (
...
//         </span>
//       </div>
//       <p className="text-white/60 text-sm">One-time payment • Live session + Community</p>
//     </div>
...
const SeminarDashboard = () => {
  ...
  const handlePayment = async () => {
    ...
    if (showForm && (!userData.email || !userData.fullName)) {
      toast.error(
        <ToastComponent
          title="Missing Information!"
          body="Please provide your email and full name to continue."
        />,
        { progress: undefined }
      );
      return;
